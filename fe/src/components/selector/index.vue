...
<style lang="less">
@import '../../assets/style/weui/widget/weui_cell/weui_access';
@import '../../assets/style/weui/widget/weui_cell/weui_cell_global';
@import '../../assets/style/weui/widget/weui_cell/weui_form/weui_form_common';
@import '../../assets/style/weui/widget/weui_cell/weui_form/weui_select_after';
